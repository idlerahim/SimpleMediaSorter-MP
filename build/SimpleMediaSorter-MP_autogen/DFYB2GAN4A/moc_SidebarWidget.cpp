...
#include "../../../src/ui/components/SidebarWidget.h"
...
void SidebarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SidebarWidget::*)(int )>(_a, &SidebarWidget::itemClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void SidebarWidget::itemClicked(int _t1)
{
